SELECT B.name [CIDADE], C.name [ESTADO], D.name [PAÍS], E.dateUpdate [ATUALIZAÇÃO], F.coordinate [LAT], G.coordinate [LONG], H.amount [TOTAL], I.amount [MORTES], J.amount [RECUPERADOS], K.amount [ATIVOS], L.name [ARQUIVO], M.recordedDt [GRAVAÇÃO] FROM Daily AS A
